 ...
 * Defers startup by one frame so the initial page paint is not blocked.
 */
export default function useHeroCanvas(bgColor = '#f0ede8', compositeOp = 'multiply', blobOpacity = 0.2) {
  ...
  useEffect(() => {
    ...
    // Defer canvas start by one frame — lets the browser paint hero text first
